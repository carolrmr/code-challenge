...
Após isso, foi feito o restore do northwind.sql fornecido pelo desafio em questão, foi criado a tabela order_details através do csv também fornecido! Comandos:
...
DELIMITER ','
CSV HEADER;
#Instalando e executando o Airflow via python3 -m venv Após instalar e iniciar o airflow, criei 3 DAGS:

DAG 01: dag_transformation_db
...
Responsável por exportar todas as tabelas do banco northwind e gravar no seguinte formato: AAAA-MM-DD/csv/tablenames.csv no destino /tmp/
...
Responsável por importar as tabelas armazenadas no /csv/tablesnames.csv para o novo banco de dados chamados northwind_datamart. Conforme solicitado, ela espera uma variável IMPORT_FRON_DATE com o valor do dia que deseja importar para a base, ser preenchida no formato: AAAA-MM-DD, caso vazio, o script pega a data do dia atual.
...
if __name__ == "__main__":
    dag.cli()
PRINTs apresentando alguns ETAPAS do code-challenge
